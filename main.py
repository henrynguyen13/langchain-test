...
"""
    ...
    summary_template = """
    Given the information {information}, provide a concise summary in 2-3 sentences.
"""
    ...
    # llm = ChatOllama(temperature=0.7, model="gemma3:270m")

    #using LCEL -> create a chain combining prompt template and llm
